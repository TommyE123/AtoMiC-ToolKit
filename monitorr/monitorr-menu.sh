#!/bin/bash
# Script Name: AtoMiC Monitorr Menu

SUBCHOICE=$(whiptail --title "AtoMiC Toolkit - Manage Monitorr" \
--menu "What would you like to do?" --backtitle "$BACKTITLE" \
--fb --cancel-button "Exit" $LINES $COLUMNS "$NETLINES" \
"Install" "Install Monitorr" \
"Uninstall" "Uninstall Monitorr" \
"Manual Update" "Manually update Monitorr" \
"Access Details" "View Monitorr access details" \
